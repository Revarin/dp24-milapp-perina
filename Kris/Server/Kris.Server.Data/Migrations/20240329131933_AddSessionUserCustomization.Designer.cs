...
namespace Kris.Server.Data.Migrations
{
    ...
    [Migration("20240329131933_AddSessionUserCustomization")]
    partial class AddSessionUserCustomization
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Kris.Server.Data.Models.MapPointAttachmentEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("MapPointAttachmentEntity");
                });
            ...
            modelBuilder.Entity("Kris.Server.Data.Models.MapPointAttachmentEntity", b =>
                {
                    b.HasOne("Kris.Server.Data.Models.MapPointEntity", "MapPoint")
            ...
            modelBuilder.Entity("Kris.Server.Data.Models.SessionUserEntity", b =>
                {
                    ...
                    b.OwnsOne("Kris.Common.Models.MapPointSymbol", "Symbol", b1 =>
                        {
                            b1.Property<Guid>("SessionUserEntityId")
                                .HasColumnType("uniqueidentifier");
                            ...
                            b1.HasKey("SessionUserEntityId");

                            b1.ToTable("SessionUsers");

                            b1.WithOwner()
                                .HasForeignKey("SessionUserEntityId");
                        });

...
namespace Kris.Server.Data.Migrations
{
    ...
    [Migration("20240228161549_MergeMainBranch")]
    partial class MergeMainBranch
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Kris.Server.Data.Models.UserPositionEntity", b =>
                {
                    ...
                    b.OwnsOne("Kris.Common.Models.GeoSpatialPosition", "Position_0", b1 =>
                        {
                            b1.Property<Guid>("UserPositionEntitySessionUserId")
                                .HasColumnType("uniqueidentifier");
                            ...
                            b1.HasKey("UserPositionEntitySessionUserId");

                            b1.ToTable("UserPositions");

                            b1.WithOwner()
                                .HasForeignKey("UserPositionEntitySessionUserId");
                        });

...
public sealed class GpsIntervalSettingsDataSource : IStaticDataSource<GpsIntervalSettingsItem>
{
    ...
    {
        new GpsIntervalSettingsItem { Value = 2, Display = "2 seconds" },
        new GpsIntervalSettingsItem { Value = 5, Display = "5 seconds" },
        new GpsIntervalSettingsItem { Value = 10, Display = "10 seconds" },
        new GpsIntervalSettingsItem { Value = 30, Display = "30 seconds" },
        new GpsIntervalSettingsItem { Value = 60, Display = "60 seconds" },
    };
